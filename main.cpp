...
int main()
{
  ...
  std::cout << "SecId1: " << example1_cache.getMatchingSizeForSecurity("SecId1") << " :: 0" << std::endl; // SecId1: 0
  std::cout << "SecId2: " << example1_cache.getMatchingSizeForSecurity("SecId2") << " :: 2700" << std::endl; // SecId2: 2700
  std::cout << "SecId3: " << example1_cache.getMatchingSizeForSecurity("SecId3") << " :: 0" << std::endl; // SecId3: 0
  ...
  std::cout << "SecId1: " << example2_cache.getMatchingSizeForSecurity("SecId1") << " :: 300" << std::endl; // SecId1: 300
  std::cout << "SecId2: " << example2_cache.getMatchingSizeForSecurity("SecId2") << " :: 1000" << std::endl; // SecId2: 1000
  std::cout << "SecId3: " << example2_cache.getMatchingSizeForSecurity("SecId3") << " :: 600" << std::endl; // SecId3: 600
  ...
  std::cout << "SecId1: " << example3_cache.getMatchingSizeForSecurity("SecId1") << " :: 900" << std::endl; // SecId1: 900
  std::cout << "SecId2: " << example3_cache.getMatchingSizeForSecurity("SecId2") << " :: 600" << std::endl; // SecId2: 600
  std::cout << "SecId3: " << example3_cache.getMatchingSizeForSecurity("SecId3") << " :: 0" << std::endl; // SecId3: 0
